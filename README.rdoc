...
Ruby library implementing GOST 34.10-2012 ECC
...
=== Usage
  ...
  # As so, Stribog message hash should be converted to big number too.
  ...
  message = 'ruby'
  hash = Stribog::CreateHash.new(message).(size).dec
  puts "hash: #{hash}"
