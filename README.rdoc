...
=== Usage
  ...
  # Note: You need to reverse input/output bytes for Stribog gem to get correct GOST 3411-2012 digest.
  ...
  signature = generator.sign(hash, private_key, rand_val)
  puts "signature.x: #{signature.x.to_s(16)}"   # x stands for r
  puts "signature.y: #{signature.y.to_s(16)}"   # y stands for s

  signature_ok = verifier.new(group).verify(hash, public_key, signature)
...
=== List of added GOST 34.10-2012 elliptic curves:

  Gost256tc26test - use for testing only! Former id-GostR3410-2001-TestParamSet
  Gost256tc26a
  Gost256tc26b    - former id-GostR3410-2001-CryptoPro-A-ParamSet
  Gost256tc26c    - former id-GostR3410-2001-CryptoPro-B-ParamSet
  Gost256tc26d    - former id-GostR3410-2001-CryptoPro-C-ParamSet
  Gost512test     - use for testing only!
  Gost512tc26a
  Gost512tc26b
  Gost512tc26c
...
Run to call signature test from source project directory:
