...
=== Usage
  ...
  sender_vko = CryptoGost3410::Generator.new(group).vko(ukm, private_key, receiver_public_key)
  puts "sender_vko.x: #{sender_vko.x.to_s(16)}"
  puts "sender_vko.y: #{sender_vko.y.to_s(16)}"

  receiver_vko = CryptoGost3410::Generator.new(group).vko(ukm, receiver_private_key, public_key)
